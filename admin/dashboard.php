<?php
/* File: admin/dashboard.php - FINAL MASTER VERSION */
session_start();
...
<head>
    ...
    <style>
        ...
        .msg-alert { background: gold; color: #000; padding: 10px; border-radius: 5px; margin: 15px 20px; text-align: center; font-weight: bold; }
    </style>
</head>
<body>

    <?php if(isset($_SESSION['msg'])): ?>
        <div class="msg-alert"><?php echo $_SESSION['msg']; unset($_SESSION['msg']); ?></div>
    <?php endif; ?>
    ...
    <div class="menu-box">
        <a href="free/channels.php" class="btn-menu"><i class="fas fa-tv"></i><br>FREE CHANNELS</a>
        <a href="profile_edit.php" class="btn-menu"><i class="fas fa-user-edit"></i><br>EDIT PROFILE</a>
        <a href="settings.php" class="btn-menu"><i class="fas fa-cogs"></i><br>SITE SETTINGS</a>
        <a href="licence.php" class="btn-menu"><i class="fas fa-key"></i><br>DEVICE LICENCE</a>
    </div>
