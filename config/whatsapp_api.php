...
// 3. API সেটিংস ফেচ করা (Error Handling সহ)
$settings = [
    'api_url' => '',
    'instance_id' => '',
    'api_token' => '',
...
function sendWhatsApp($phone, $message) {
    ...
    // কানেকশন টাইমআউট অপটিমাইজেশন
    curl_setopt($ch, CURLOPT_CONNECTTIMEOUT, 10);
    curl_setopt($ch, CURLOPT_TIMEOUT, 20);
    
    // SSL সেফটি (সার্ভারে ইস্যু থাকলে এটি ব্যবহার করুন, তবে প্রোডাকশনে ভেরিফাই রাখা ভালো)
