...
#adContainer{position:relative;display:flex;justify-content:center;align-items:center;background:#000;}
#adFrame{border:none;}
.ad-timer{position:absolute;top:20px;right:20px;color:gold;font-size:20px;font-weight:bold;z-index:100001;}
...
<div id="adOverlay">
    ...
    <div id="adContainer">
        ...
        <iframe id="adFrame" allow="autoplay; fullscreen; encrypted-media; picture-in-picture" allowfullscreen></iframe>
    </div>
</div>
